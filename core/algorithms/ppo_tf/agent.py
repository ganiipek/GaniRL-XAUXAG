...
from algorithms.ppo_tf.memory import PPOMemory
from algorithms.ppo_tf.networks import ActorNetwork, CriticNetwork


class Agent:
    def __init__(self, n_actions, input_dims, gamma=0.99, alpha=0.0003, lr=0.00001,
