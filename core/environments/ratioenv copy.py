...
class Position:
    ...
    def get_profit(self):
        ...
        self.profit = (
            (self.close_price - self.open_price) if self.type == PositionType.BUY else
            (self.open_price - self.close_price)
        ) * self.volume * self.symbol.contract_size
...
class RatioEnv:
    ...
    def update_transaction_history(self, transaction:Transaction):
        ...
        self.transaction_history_length += 1
    ...
    def step(self, action:int):
        ...
        info = {
            ...
            "transaction_count": self.transaction_history_length
            }
